  ...
  $(document).ready(function () {
    ...
    Animation.prototype.setUpElements = function () {
      ...
      for (var i = 0; i < this.animationArray.length; i++) {
        ...
        $(this.animationArray[i]).find('.label3').html('JQUERY: ' + percentage + '%');
        $(this.animationArray[i]).find('.label4').html('MEDIA QUERY: ' + percentage + '%');
        $(this.animationArray[i]).find('.label5').html('BOOT STRAP: ' + percentage + '%');
        $(this.animationArray[i]).find('.label6').html('JAVA SCRIPT: ' + percentage + '%');
      }
